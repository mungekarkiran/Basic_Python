...
text = tk.Text(root, wrap=tk.WORD, width=40, height=30, bg="light pink")
text.pack()

# Create a label to display the time
time_label = tk.Label(root, text="", bg="light yellow")
time_label.pack()
...
save_button = tk.Button(root, text="Save Note", command=save_note, bg="light green")
save_button.pack()
